...
function SignedXml(idMode, options) {
  console.log('Function => SignedXml');
  ...
  this.canonicalizationAlgorithm = this.options.canonicalizationAlgorithm || "http://www.w3.org/TR/2001/REC-xml-c14n-20010315"
  this.signedXml = ""
  this.signatureXml = ""
...
SignedXml.prototype.checkSignature = function (xml) {
  ...
  if (!this.validateSignatureValue(doc)) {
    console.log('validateSignatureValue')
    console.log(false)
    return false;
  }
...
SignedXml.prototype.getCanonReferenceXml = function (doc, ref, node) {
  ...
  if (Array.isArray(ref.transforms)) {
    ...
    // console.log('RefTransforms')
    // console.log(ref.transforms)
    ref.ancestorNamespaces = findAncestorNs(doc, ref.xpath)
    // console.log('ref AncestorNamespaces')
    // console.log(ref.ancestorNamespaces)
  }
...
SignedXml.prototype.addReference = function (xpath, transforms, digestAlgorithm, uri, digestValue, inclusiveNamespacesPrefixList, isEmptyUri) {
  console.log('Function => addReference')
  this.references.push({
    "xpath": xpath,
    "transforms": transforms ? transforms : ["http://www.w3.org/TR/2001/REC-xml-c14n-20010315", "http://www.w3.org/2000/09/xmldsig#enveloped-signature"],
...
SignedXml.prototype.computeSignature = function (xml, opts) {
  console.log('Function => computeSignature');
  var doc = new Dom().parseFromString(xml),
    xmlNsAttr = "xmlns",
    signatureAttrs = [],
    location,
  ...
  // console.log(validActions.indexOf(location.action));
  ...
  // console.log(signatureAttrs);

  var signatureXml = "<" + currentPrefix + "Signature " + signatureAttrs.join(" ") + ">"

  //  console.log(doc.toString());
  //  console.log(signatureXml);

  signatureXml += this.createSignedInfo(doc, prefix);//Bem aqui ele já muda o xml de entrada
  ...
  // console.log(this.originalXmlWithIds);
  ...
  // console.log(existingPrefixesString);
  ...
  // console.log(dummySignatureWrapper);
  ...
  // console.log(referenceNode.parentNode.toString());

  /**
   * Aqui é adicionada a assinatura na nota...
   */

  if (location.action === "append") {

    var NFeNode = utils.findChilds(referenceNode, "NFe")
    NFeNode = NFeNode[0];

    var infNFeNode = utils.findChilds(NFeNode, "infNFe")
    NFeNode.insertBefore(signatureDoc, infNFeNode.nextSibling);
  ...
  // console.log(signatureXml);
  // console.log(referenceNode.toString());

  this.signatureNode = signatureDoc
  this.calculateSignatureValue(doc)

  // console.log(this.signatureNode.toString());
  ...
  // console.log(signedInfoNode.toString());
  // console.log(prefix);
  ...
  // console.log(this.signedXml);
}

SignedXml.prototype.getKeyInfo = function (prefix) {
  console.log('Function => getKeyInfo');
  var res = ""
  var currentPrefix
  ...
  // console.log('TestSignTestSignTestSignTestSignTestSignTestSignTestSignTestSignTestSignTestSignTestSignTestSignTestSign');
  // console.log(res);
  return res
}
...
SignedXml.prototype.createReferences = function (doc, prefix) {
  console.log('Function => createReferences');
  var res = ""
  ...
  for (var n in this.references) {
    ...
    // console.log(ref.xpath);

    var nodes = xpath.select(ref.xpath, doc);
    ...
    for (var h in nodes) {
      ...
      var node = nodes[h]
      //Verifica se a uri do xml está preenchida
      if (ref.isEmptyUri) {
...
SignedXml.prototype.getCanonXml = function (transforms, node, options) {
  ...
  // console.log('----------------Options---------------');
  // console.log(options.signatureNode);
  ...
  // console.log('CTCTCTCTTCCTTCTCTCTCTCTTCTCTCTCTTCTCTCTCTCTTCTCTCTC');
  // console.log(canonXml.toString());
  // console.log('CTCTCTCTTCCTTCTCTCTCTCTTCTCTCTCTTCTCTCTCTCTTCTCTCTC');
