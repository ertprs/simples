    ...
    methods: {
            ...
            dialog.showOpenDialog((fileNames) => {
                ...
                fs.readFile(fileNames[0], 'utf-8', (err, data) => {
                    ...
                    for (let z = 0; z < resultJSON[0].nfeProc.NFe.infNFe.det.length; z++) {
                        ...
                        else if (resultJSON[0].nfeProc.NFe.infNFe.det[z].imposto.ICMS.ICMS102) {
                            vICMS = resultJSON[0].nfeProc.NFe.infNFe.det[z].imposto.ICMS.ICMS102.vICMS._text;
                            // cstICMS = resultJSON[0].nfeProc.NFe.infNFe.det[z].imposto.ICMS.ICMS102.CST._text;
                            cstICMS = "102";
                            vBC_ICMS = resultJSON[0].nfeProc.NFe.infNFe.det[z].imposto.ICMS.ICMS102.vBC._text;
                            pICMS_ICMS = resultJSON[0].nfeProc.NFe.infNFe.det[z].imposto.ICMS.ICMS102.pICMS._text;
                        }
                        else if (resultJSON[0].nfeProc.NFe.infNFe.det[z].imposto.ICMS.ICMSSN102) {
                            cstICMS = "102";
                        }

                        console.log(resultJSON[0].nfeProc.NFe.infNFe.det[z].prod.vProd._text);
                        ...
                        this.produtoV2 = {
                            ...
                            preco_compra: resultJSON[0].nfeProc.NFe.infNFe.det[z].prod.vProd._text,
                            preco_custo: "",
                            custo_medio: "",
                        ...
                        if (this.produtoV2.codigo_barras == "SEM GTIN") {
                            produto = produtosV2.find({ 'codigo': this.produtoV2.codigo_barras });
                            quantidade = 0;
                        } else {
                            produto = produtosV2.find({ 'codigo_barras': this.produtoV2.codigo_barras });
                            quantidade = 0;
                        }
        ...
        viewNote: function (data) {
            ...
            for (let x = 0; x < resultJSON.length; x++) {
                ...
                if (!resultJSON[0].nfeProc.NFe.infNFe.dest.enderDest.fone) {
                    fone_dest = "";
                }
                else {
                ...
                if (!resultJSON[0].nfeProc.NFe.infNFe.transp.transporta) {
            ...
            for (let z = 0; z < resultJSON[0].nfeProc.NFe.infNFe.det.length; z++) {
                ...
                produtos = produtos + '<tr class="titles">'
                    ...
                    + '<td class="valUnit">' + resultJSON[0].nfeProc.NFe.infNFe.det[z].prod.vProd._text + '</td>'
                    + '<td class="valTotal">' + resultJSON[0].nfeProc.NFe.infNFe.det[z].prod.vProd._text * resultJSON[0].nfeProc.NFe.infNFe.det[z].prod.qCom._text + '</td>'
            ...
            let html = '<!-- Header -->'
                ...
                + '         <tbody>'
                + '             <tr>'
                + '                 <td style="width: 46mm; font-size: 7pt;" class="txt-center">'
                ...
                + '                     </span>'
                + '                 </td>'
                + '                 <td class="txtc txt-upper" style="width: 34mm; height: 29.5mm;">'
                ...
                + '                         <span class="bold block txt-center info">' + chave_acesso + '</span>'
                + '                     </div>'
                + '                     <div class="txt-center valign-middle">'
