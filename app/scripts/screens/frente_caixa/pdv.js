    ...
    methods: {
        loadConfig: function () {
            console.info("INFO:",
                {
                    "METHOD": "loadConfig",
                    "DESCRIPTION": "LOAD CONFIGS OF THE SYSTEM"
                });
        ...
        loadDataPattern: function () {
            console.info("INFO:",
                {
                    "METHOD": "loadDataPattern",
                    "DESCRIPTION": "LOAD DATA OF THE SYSTEM"
                });
        ...
        fillPatternNote: function () {
            console.info("INFO:",
                {
                    "METHOD": "fillPatternNote",
                    "DESCRIPTION": "FILL FLIEDS PATTERN OF THE NOTE"
                });
        ...
        /*
        |=====================================================
        |=======Add products in note based in ICMSSN102=======
        |=====================================================
        */
        adicionarProdutosNaNFCEICMSSN102: function () {
            console.info("INFO:",
                {
                    "METHOD": "adicionarProdutosNaNFCEICMSSN102",
                    "DESCRIPTION": "ADD PRODUCTS IN NOTE BASED ICMSSN102",
                    "QUANTITY WORDS PRICE": String(this.venda.produto[0].preco).length
        ...
        pushListProduct: function () {
            ...
            console.info("INFO:",
                {
                    "METHOD": "pushListProduct",
                    "DESCRIPTION": "LIST TO PRODUCTS",
                    "DATA": this.venda.listProduto
                });
        ...
        toQtde: function () {
            console.info("INFO:",
                {
                    "METHOD": "toQtde",
                    "DESCRIPTION": "GO TO FIELD OF THE PRODUCT QUANTITY "
                });
        ...
        toDiscount: function () {
            console.info("INFO:",
                {
                    "METHOD": "toDiscount",
                    "DESCRIPTION": "GO TO FIELD OF THE PRODUCT DISCOUNT "
                });
            document.getElementById("descontoInFocus").disabled = false;
        ...
        toValueReceived: function () {
            console.info("INFO:",
                {
                    "METHOD": "toValueReceived",
                    "DESCRIPTION": "GO TO FIELD OF THE PRODUCT VALUE "
                });
            ...
            */
            if (this.venda.produto[0].desconto == '' || this.venda.produto[0].desconto < 0) {
                ...
                console.info('INFO:',
                    {
                        ...
                        'Preço - Desconto(String)': resultado.toFixed(2)
                    });
                ...
                console.info('Dados para leitura:', this.venda.totalParaLeitura);
                ...
                console.info('INFO:',
                    {
                        'TOTAL FOR READ': this.venda.totalParaLeitura
                    });
                ...
                console.info("INFO:",
                    {
                        "totalParaLeituraShow": this.venda.totalParaLeituraShow,
                        "totalParaLeituraEmString": this.venda.paraExibirNatela[0].totalParaLeituraEmString
                    });
        ...
        focusInProductField: function () {
            console.info("INFO:",
                {
                    "METHOD": "focusInProductField",
                    "DESCRIPTION": "PUT FOCUS IN SEARCH PRODUCTS FIELD"
                });
