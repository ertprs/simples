        ...
        methods: {
            ...
            mountCupom: function () {
                ...
                let cupom = '<!DOCTYPE html>'
                    ...
                    + '<p style="text-align: center; margin: 0px">Documento Não Fiscal</p>'
                    // + '<br>'
            ...
            toValueReceived: function () {
                ...
                if (this.venda.produto[0].desconto == '' || this.venda.produto[0].desconto < 0) {
                    ...
                    this.venda.totalParaLeituraShowString = String(this.venda.totalParaLeituraShow).replace('.', ',');

                    console.log(this.venda.totalParaLeituraShow);
                    console.log(this.venda.totalParaLeituraShowString);
