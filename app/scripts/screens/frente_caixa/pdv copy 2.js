...
var registroDeNotas = db.getCollection('registroDeNotas');
...
new Vue({
    ...
    methods: {
        ...
        loadDataPattern: function () {
            ...
            console.log(this.registroDeNotas);
        },
        ...
        toDiscount: function () {
            ...
            if (this.venda.produto[0].quantidade == '') {
                ...
                dialog.showMessageBox({
                    message: 'Este campo não pode ser preenchido com valores menores que zero ou iguais a zero!',
                });
                document.getElementById("qtdeInFocus").focus();
            }
            else {
